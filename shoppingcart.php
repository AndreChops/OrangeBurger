<?php
    ...
    if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] === false){
        echo "<script>window.location='index.php?log_err=0'</script>";
        exit();
    }
                            ...
                            '<div class="basket-product">'.
                                '<div class="item">'.
                                    '<div class="product-image">'.
                                        '<img src="'.$path.$row["gambar"].'" alt="'.$row["nama"].'" class="product-frame">'.
                                    '</div>'.
                                    '<div class="product-details" style="padding-top:6px">'.
                                        '<h1 style="font-size: 1.5rem"><strong>'.$row["nama"].'</strong></h1>'.
                                        '<p>'.$row["deskripsi"].'</p>'.
                                    '</div>'.
                                '</div>'.
                                '<div class="price" style="padding-top:6px">'.$row["harga"].'</div>'.
                                '<div class="quantity" style="padding-top:6px; text-align:center">1</div>'.
                            '</div>';

                        $_SESSION["total"] += $row["harga"];
                    }
                }
            }   
        }
...
<html lang="en">
  ...
  <head>
    ...
    <title>Orange Burger | Shopping Cart</title>
    ...
    <div class="basket">
      ...
      <?php if(isset($_SESSION["orders"])){ echo $_SESSION["orders"]; } ?>
    </div>
    <aside>
      <div class="summary">
        ...
        <div class="summary-total">
          ...
          <div class="total-value final-value" id="basket-total"><?php if(isset($_SESSION["total"])){ echo $_SESSION["total"]; } ?></div>
        </div>
        <div class="summary-checkout">
          <a href="clearshoppingcart.php"><button class="checkout-cta">Checkout</button></a>
        </div>
      </div>
    </aside>
    </section>
